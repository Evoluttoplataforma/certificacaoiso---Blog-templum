---
title: "ISO 27001 – O que é e como implementar a norma e certificar sua empresa"
description: "Existem 05 grandes etapas na implementação da ISO 27001, que são: Contexto da Organização, Avaliação de Riscos, Controles Operacionais, Análise de Eficácia, e, Melhoria."
tldr: "A ISO 27001 é a norma internacional de gestão da segurança da informação (SGSI): ela estabelece um framework para identificar riscos e implementar controles que protegem a confidencialidade, integridade e disponibilidade dos dados. A implementação passa por cinco etapas — contexto, avaliação de riscos, controles operacionais, análise de eficácia e melhoria."
pubDate: 2019-11-11T15:23:12.000Z
updatedDate: 2025-01-08T10:46:38.000Z
author: "Daniela Albuquerque"
categories: ["Segurança e Compliance"]
heroImage: "/wp-content/uploads/2019/11/ISO-27001-–-O-que-e-e-como-implementar-a-norma-e-certificar-sua-empresa.webp"
wpId: 27265
draft: false
---
...
É sobre isso esse risco que a [ISO 27001](https://certificacaoiso.com.br/relacao-da-iso-27001-com-o-home-office/) aborda e que vamos detalhar nesse texto.

### O que é a ISO 27001?

A [ISO 27001](https://certificacaoiso.com.br/tudo-o-que-precisa-saber-sobre-a-iso-27001-e-seguranca-da-informacao/), também conhecida como ISO/IEC 27001, é uma norma internacional de gestão de segurança da informação, formulada para atender as melhores práticas internacionais na segurança e proteção dos dados presentes em uma organização.

Quem implementa a [ISO 27001](https://templum.com.br/consultoria/iso-27001) (ISO IEC 27001) demonstra um alto compromisso com a proteção das informações, da corporação e de seus clientes, uma das principais preocupações da atualidade.
...
É sempre **importante lembrar que a ISO 27001**, como qualquer outra norma ISO, **não é uma solução pronta**, mas uma abordagem que se molda ao [contexto da sua organização](https://certificacaoiso.com.br/iso-9001-contexto-da-organizacao/).
...
[![Consultoria para implementação da ISO 27001 é com a Templum](/wp-content/uploads/2020/03/27001.webp)](https://templum.com.br/form?utm_source=blog&utm_medium=banner-artigo&utm_campaign=iso-27001)
...
Na prática, uma empresa com a certificação [ISO 27001](https://certificacaoiso.com.br/empresas-que-precisam-da-iso-27001/) (SGSI) garante ao mercado que se preocupa com segurança dos dados, mantendo-os seguros, disponíveis, íntegros e confidenciais, ou seja, é uma organização em que posso oferecer minhas informações com a segurança de que estão sendo bem geridos.

## Por que estão exigindo a certificação ISO 27001 (SGSI)?

Todos os grandes mercados organizados, como a União Europeia criaram nos últimos anos legislações que tratam da [proteção de dados](https://certificacaoiso.com.br/lgpd/), ou seja, **todas as empresas que atuam nesse mercado precisam se adequar o mais rápido possível.**
...
A **certificação ISO 27001 auxilia as organizações** a cumprirem com diversas normas e padrões, **garantindo mais segurança e confiabilidade para clientes e** [**partes interessadas**](https://certificacaoiso.com.br/requisitos-4-2-partes-interessadas/)**.**
...
Então, agora é o ponto da virada para começar a [consultoria ISO 27001](https://certificacaoiso.com.br/consultoria-iso-27001/).
...
Este ponto abrange estruturas de suporte, alocação de recursos, e comunicação, todos cruciais para sustentar o [sistema de gestão](https://certificacaoiso.com.br/como-implementar-um-sistema-de-gestao-de-forma-eficiente/) de segurança da informação (SGSI).

A documentação detalhada e a implementação de práticas robustas de TI são [pilares da gestão](https://certificacaoiso.com.br/os-3-pilares-da-gestao-da-qualidade-simplificado-a-gestao/) que sustentam o funcionamento diário do SGSI.

O planejamento [operacional e a gestão](https://certificacaoiso.com.br/gestao-operacional-5-passos-para-aplicar-no-seu-negocio-simplificando-a-gestao/) de riscos garantem que as operações de segurança da informação estejam alinhadas com as necessidades práticas da organização, permitindo avaliações de [desempenho](https://certificacaoiso.com.br/desempenho-performance-como-analisar/) consistentes e confiáveis.
...
Existem 05 grandes etapas na implementação da norma [ISO 27001](https://certificacaoiso.com.br/vantagens-da-iso-27001/), que são:
...
Estágio um é uma análise preliminar, a famosa e temida [Auditoria Interna](https://certificacaoiso.com.br/beneficios-de-uma-auditoria/) da norma iso 27001, informal do SGSI, na verificação da existência e completude da documentação chave como a política de segurança da informação da organização, Declaração de Aplicabilidade (do inglês Statement of Applicability - SoA ) e Plano de Tratamento de Risco (PTR). ão e foque as ações do SGSI na mitigação desses riscos.
...
Na última (e primeira) etapa temos o estágio de [melhoria contínua](https://certificacaoiso.com.br/melhoria-continua-processo-gradual-ou-de-ruptura/) a partir do estabelecimento da Certificação para garantir que o sistema de gestão está em constante avaliação e monitoramento dos riscos identificados e possíveis novos controles operacionais. Por isso indico que também é a primeira etapa de um novo PDCA que se inicia na empresa.

[![CONSULTORIA ISO 27001](/wp-content/uploads/2020/03/27001.webp)](https://templum.com.br/form?utm_source=blog&utm_medium=banner-artigo&utm_campaign=iso-27001)

## Na prática, o que será avaliado?

Na norma [ISO 27001](https://certificacaoiso.com.br/iso-27001-e-iso-9001/) e seus requisitos está disponível o Anexo A que indica quais são os controles internos que devem passar por avaliação de conformidade, seguindo as políticas e objetivos de segurança da informação de cada empresa.
...
1.  **Equipe**: quem são as pessoas que farão parte da [gestão desse projeto](https://certificacaoiso.com.br/gestao-de-projeto-e-desenvolvimento/) e o nível de conhecimento dos procedimentos internos e do negócio. Como é uma norma de gestão de risco, quanto maior o conhecimento sobre a organização, mais ágil será o processo de implementação.
